...
class SupplyDetailsRelationManager extends RelationManager
{
    protected static string $relationship = 'SupplyDetails';

    protected static ?string $title = 'تفاصيل التوريد';
    protected static ?string $modelLabel = 'تفاصيل التوريد';
    ...
    {
        return $table
            ->recordTitleAttribute('تفاصيل التوريد')
            ->columns([
